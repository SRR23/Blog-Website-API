...
# This serializer is used to display related blogs in the BlogDetail view.
class RelatedBlogSerializer(serializers.ModelSerializer):
    ...
    def get_related(self, obj):
        ...
        related_blogs = obj.related  # Limit to 5 related blogs for brevity
        serializer = BlogSerializer(related_blogs, many=True, context=self.context)
